...
tool-color-palette の current release-driven development で使用する Operating Model を定義します。
...
- Color conversion/palette behavior is product logic; verify representative values independently from host rendering.
